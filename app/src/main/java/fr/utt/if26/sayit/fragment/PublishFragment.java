    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        publishButtonView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ItSaysEndpoints.PublicationEndpoint.publish(token, expressionFieldView.getText().toString(), ((Country) langageSpinnerView.getSelectedItem()).getIsoCode(), getContext(), new ApiHttpClient.ApiCallFinished() {
                    @Override
